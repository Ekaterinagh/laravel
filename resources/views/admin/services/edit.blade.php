...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::textarea('description', old('description',$services->description), array('class'=>'form-control ckeditor')) !!}
    ...
    {!! Form::label('promotion', 'promotion', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::text('promotion', old('promotion',$services->promotion), array('class'=>'form-control')) !!}
