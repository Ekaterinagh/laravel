...
{!! Form::open(array('files' => true, 'route' => config('quickadmin.route').'.artists.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::text('salon_id', old('salon_id'), array('class'=>'form-control')) !!}
        
    </div>
</div><div class="form-group">
    {!! Form::label('contacts', 'contacts', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::text('contacts', old('contacts'), array('class'=>'form-control')) !!}
